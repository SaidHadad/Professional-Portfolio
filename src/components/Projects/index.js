  ...
  return (
    ...
    <div className="project3">
      <div className="content">
        ...
        <a className="mainbtn btn3" target="blank" href="https://saidhadad.github.io/TaskMaster-Pro/">App View</a>
        <a className="mainbtn btn3" target="blank" href="https://github.com/SaidHadad/TaskMaster-Pro">Source Code</a>
      </div>
    </div>
    {/* <!-- Note Taker --> */}
    <div className="project4">
      <div className="content">
        ...
        <a className="mainbtn btn3" target="blank" href="https://vert-fromage-04848.herokuapp.com/notes">App View</a>
        <a className="mainbtn btn3" target="blank" href="https://github.com/SaidHadad/Challenge-11-Note-Taker">Source Code</a>
      </div>
    </div>
    {/* <!-- Weather Dashboard --> */}
